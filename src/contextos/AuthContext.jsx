...
const AuthProvider = ({children}) => {
	...
	// cargar la comprobacion de onAuthStateChanged que trae al usuario y lo almacena en el estado usuario
	...
	useEffect(() => {
		...
		const cancelarSuscripcion = onAuthStateChanged(auth, (usuario) => {
            //el usuario obtenido con onAuthStateChanged devulve y envia al usuario del AuthContext.Provider
