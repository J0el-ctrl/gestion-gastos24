...
import IconoDown from './../imagenes/down.svg?react';
...
// recibo los props de FormularioGasto
export const SelectCategorias = ({categoria, cambiarCategoria}) => {
